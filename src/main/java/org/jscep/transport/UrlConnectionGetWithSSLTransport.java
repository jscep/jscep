...
/**
 * AbstractTransport representing the <code>HTTP GET</code> method with SSL support
 */
@ThreadSafe
final class UrlConnectionGetWithSSLTransport extends AbstractTransport {
    private static final Logger LOGGER = LoggerFactory
            .getLogger(UrlConnectionGetWithSSLTransport.class);
     ...
     */
    public UrlConnectionGetWithSSLTransport(final URL url, final SSLSocketFactory sslSocketFactory) {
        super(url);
