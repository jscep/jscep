...
/**
 * AbstractTransport representing the <code>HTTP POST</code> method with SSL support
 */
@ThreadSafe
final class UrlConnectionPostWithSSLTransport extends AbstractTransport {
    private static final Logger LOGGER = LoggerFactory
            .getLogger(UrlConnectionPostWithSSLTransport.class);
     ...
     */
    public UrlConnectionPostWithSSLTransport(final URL url,
