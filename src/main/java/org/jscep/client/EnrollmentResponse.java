...
public final class EnrollmentResponse {
	...
	private EnrollmentResponse(TransactionId transId, CertStore certStore, FailInfo failInfo) {
	 ...
	 * <p>
	 * If this method is invoked on a non-success response, this method will throw an {@link IllegalStateException}
	 * 
	 ...
	 * <p>
	 * If this method is invoked on a non-failure response, this method will throw an {@link IllegalStateException}
	 * 
